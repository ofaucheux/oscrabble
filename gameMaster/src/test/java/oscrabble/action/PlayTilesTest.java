...
class PlayTilesTest
{
	...
	void parseMove() throws ParseException
	{
		...
		final PlayTiles chien = (PlayTiles) PlayTiles.parseMove(grid, a13_chien, true);
		...
		final PlayTiles chat = (PlayTiles) PlayTiles.parseMove(grid, _12F, true);
	...
	{
		final PlayTiles chien = (PlayTiles) PlayTiles.parseMove(grid, "A13 CHIEN", true);
