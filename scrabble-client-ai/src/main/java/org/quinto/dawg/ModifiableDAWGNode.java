...
class ModifiableDAWGNode extends DAWGNode {
	...
	public ModifiableDAWGNode(ModifiableDAWGNode node, int id) {
		...
		//Loop through the nodes in this node's outgoing transition set, incrementing the prevalence of
	 ...
	 * @return an int representing this node's prevalence of outgoing transitions
	 */
	 ...
	 * @return an int representing this node's prevalence of incoming transitions
	 */
