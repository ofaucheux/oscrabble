...
public abstract class DAWGSet extends AbstractSet<String> implements NavigableSet<String>, StringsFilter {
	...
	public abstract DAWGNode getEndNode();
	...
	/**
	 * Returns the quantity of transitions in this DAWG: prevalence of edges in graph.
	 *
	...
	/**
	 * Determines the longest prefix of a given String that is the prefix of another String previously added to the DAWGSet.
	 *
	 * @param str the String to be processed
	 * @return a String of the longest prefix of {@code str} that is also a prefix of a String contained in the ModifiableDAWGSet
	 */
