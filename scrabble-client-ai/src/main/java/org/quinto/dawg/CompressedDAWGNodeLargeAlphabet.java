...
class CompressedDAWGNodeLargeAlphabet extends CompressedDAWGNode {
	 ...
	 * @return the CompressedDAWGNode that is the target of the transition labeled with {@code letter}, or null if there is no such labeled transition from this node
	 */
	@Override
