...
public abstract class DAWGNode {
	 ...
	 * @return the DAWGNode that is the target of the transition labeled with {@code letter}, or null if there is no such labeled transition from this node
	 */
	 ...
	 * @return the ModifiableDAWGNode at the end of the transition path corresponding to {@code str}, or null if such a transition path is not present in the DAWG
	 */
